<%@ Page Title="Manage Account" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.vb" Inherits="ScatterRadarLine.Account.Manage" %>
