<%@ Page Language="vb" Title="Register an external login" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="ScatterRadarLine.Account.RegisterExternalLogin" %>
